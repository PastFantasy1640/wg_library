...
//コンストラクタ
wg::graphics::ImageSequence::ImageSequence(void) {
	this->filepath = "";
...
//コピーコンストラクタ
wg::graphics::ImageSequence::ImageSequence(const ImageSequence & copy) {
...
//読み込み関数
void wg::graphics::ImageSequence::setLoadFile(const std::string fpath){
	filepath = fpath;
}

void wg::graphics::ImageSequence::LoadFile(const LoadType type, const std::string fpath) {
	this->setLoadFile(fpath);
	this->LoadFile(type);
}

void wg::graphics::ImageSequence::play(const double speed){
...
void wg::graphics::ImageSequence::stop(void) {
...
void wg::graphics::ImageSequence::DrawSequence(sf::RenderTexture * screen_buffer, const float x, const float y, const float ex){
	//エラーチェック
...
void wg::graphics::ImageSequence::DrawFrame(const unsigned int frame, sf::RenderTexture * screen_buffer, const float x, const float y, const float ex)
{
...
const sf::Texture * wg::graphics::ImageSequence::operator[](unsigned int frame) const
{
...
std::string wg::graphics::ImageSequence::getFilePath(void) const
{
	return this->filepath;
}

std::size_t wg::graphics::ImageSequence::getNonloadFrame(void) const
{
	return this->nonload_thread;
}

std::size_t wg::graphics::ImageSequence::getAllFrames(void) const
{
	return this->data_size;
}

unsigned int wg::graphics::ImageSequence::getPlayFrame(void) const
{
	if(this->is_play) return play_frame;
	return -1;
}

bool wg::graphics::ImageSequence::getIsPlaying(void) const
{
	return this->is_play;
}

sf::Time wg::graphics::ImageSequence::getPlayingTime(void) const
{
	return this->timer.getElapsedTime();
}

void wg::graphics::ImageSequence::setFPS(unsigned int fps)
{
	this->fps = fps;
}

void wg::graphics::ImageSequence::DivideImage(const unsigned int width, const unsigned int height, const unsigned int div_xnum, const unsigned int div_ynum, const unsigned int frame)
{
	...
	for (int x = 0; x < div_xnum && now_frame < frame; x++) {
		for (int y = 0; y < div_ynum && now_frame < frame; y++) {
...
bool wg::graphics::ImageSequence::getLoadedFlag(void) const
{
	return this->is_loaded;
}

bool wg::graphics::ImageSequence::getErrorFlag(void) const
{
	return this->is_error;
}

void wg::graphics::ImageSequence::LoadFile(const LoadType type) {
...
void wg::graphics::ImageSequence::pBufTh(void) {
...
void wg::graphics::ImageSequence::loadTh(std::vector<Data*> data){
	sf::Clock lt;
...
void wg::graphics::ImageSequence::setLoopFlag(const bool flag){
	this->loop = true;
}

bool wg::graphics::ImageSequence::getLoopFlag(void) const
{
	return this->loop;
}

void wg::graphics::ImageSequence::setInPoint(const unsigned int frame)
{
	in_frame_ = frame;
}

void wg::graphics::ImageSequence::setOutPoint(const unsigned int frame)
{
	out_frame = frame;
}
